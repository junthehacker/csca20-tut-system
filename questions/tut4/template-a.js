...
const app = new Vue({
    ...
    data: {
        ...
        currentSection: 0,
        studentAnswer: EXISTING_RESPONSE ? EXISTING_RESPONSE.studentAnswer : [],
        failedAttempts: EXISTING_RESPONSE ? EXISTING_RESPONSE.failedAttempts : [],
        currentLine: "",
        hasError: false,
    },
    methods: {
